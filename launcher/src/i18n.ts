...
const ptBR: Record<keyof typeof en, string> = {
  ...
  uninstallIntegration: "Remover integração do Codex",
  uninstallIntegrationBody: "Restaura a rota anterior do Codex e remove o runtime privado da ponte.",
  integrationRemoved: "Integração removida; reinicie o Codex",
  running: "Executando",
  complete: "Concluído",
  failed: "Falhou",
  healthy: "Saudável",

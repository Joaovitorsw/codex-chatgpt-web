...
const en = {
  ...
  activeTaskHidden: "Task active in the background",
  activeTaskHiddenBody: "ChatGPT is still thinking and Codex is continuing to validate the live turn. Open ChatGPT to follow its progress.",
  ...
  bundledSkillsTitle: "Bundled Codex skills",
  bundledSkillsBody: "Choose which skills from this app to keep in Codex. Deselected managed skills are removed; personal skills are never deleted.",
  keepAllSkills: "Keep all",
  removeAllSkills: "Remove all",
  ...
  uninstallIntegration: "Restore native Codex",
  uninstallIntegrationBody: "Back up and restore the previous native Codex route, remove only managed Web GPT integration data, then restart Codex once.",
  integrationRemoved: "Native Codex restored; restart Codex once",
  running: "Running",
  complete: "Complete",
  failed: "Failed",
  healthy: "Healthy",
...
const zh: Record<keyof typeof en, string> = {
  ...
  activeTaskHidden: "任务正在后台运行",
  activeTaskHiddenBody: "ChatGPT 仍在思考，Codex 正在继续验证当前任务。打开 ChatGPT 可查看进度。",
  browserReady: "浏览器已就绪",
  ...
  bundledSkillsTitle: "内置 Codex 技能",
  bundledSkillsBody: "选择要保留在 Codex 中的应用内置技能。取消选择的托管技能会被移除，个人技能不会被删除。",
  keepAllSkills: "全部保留",
  removeAllSkills: "全部移除",
...
const ja: Record<keyof typeof en, string> = {
  ...
  activeTaskHidden: "タスクはバックグラウンドで実行中です",
  activeTaskHiddenBody: "ChatGPT はまだ思考中で、Codex はライブターンの検証を続けています。進行状況を見るには ChatGPT を開いてください。",
  ...
  bundledSkillsTitle: "同梱 Codex スキル",
  bundledSkillsBody: "このアプリから Codex に残すスキルを選択します。選択解除した管理対象スキルのみ削除され、個人スキルは削除されません。",
  keepAllSkills: "すべて保持",
  removeAllSkills: "すべて削除",
...
const ko: Record<keyof typeof en, string> = {
  ...
  activeTaskHidden: "작업이 백그라운드에서 실행 중입니다",
  activeTaskHiddenBody: "ChatGPT가 아직 생각 중이며 Codex가 실시간 턴을 계속 검증하고 있습니다. 진행 상황을 보려면 ChatGPT를 여세요.",
  ...
  bundledSkillsTitle: "번들 Codex 스킬",
  bundledSkillsBody: "이 앱에서 Codex에 유지할 스킬을 선택하세요. 선택 해제한 관리 스킬만 제거되며 개인 스킬은 삭제되지 않습니다.",
  keepAllSkills: "모두 유지",
  removeAllSkills: "모두 제거",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  activeTaskHidden: "任務正在背景執行",
  activeTaskHiddenBody: "ChatGPT 仍在思考，Codex 正繼續驗證當前任務。開啟 ChatGPT 即可查看進度。",
  browserReady: "瀏覽器已就緒",
  ...
  bundledSkillsTitle: "隨附 Codex 技能",
  bundledSkillsBody: "選擇要保留在 Codex 的應用程式技能。取消選取的受管理技能會被移除，個人技能不會被刪除。",
  keepAllSkills: "全部保留",
  removeAllSkills: "全部移除",
...
const ptBR: Record<keyof typeof en, string> = {
  ...
  devCoreSetup: "Perfil DEV",
  devStepInstall: "Inicializar ambiente DEV",
  devStepInstallBody: "Salva os recursos da conta no ambiente DEV isolado. Nenhuma rota do Codex, listener de Responses ou serviço do sistema é instalado; o modo Full supervisiona apenas o túnel MCP isolado.",
  devInstall: "Inicializar perfil",
  devReinstall: "Atualizar perfil",
  devMcpTitle: "Ferramentas simuladas via MCP",
  devMcpSubtitle: "Conecte esta conta separada do ChatGPT ao ambiente isolado do repositório.",
  devMcpBody: "O launcher DEV mantém o túnel MCP isolado pronto. Conversas nomeadas do repositório se conectam a ele e retornam recibos explícitos para ações de ferramentas.",
  devConnectorIsolationNotice: "Crie um conector separado com o nome DEV exato abaixo. Mantenha Codex Native2 inalterado para executar produção e desenvolvimento lado a lado.",
  devSettingsTitle: "Configurações do perfil DEV",
  devKeepRunningBody: "Mantenha a sessão isolada do navegador e o túnel MCP DEV disponíveis ao fechar esta janela.",
  biggerContext: "Contexto maior (experimental)",
  biggerContextBody: "Aviso: mantém tarefas pequenas em uma mensagem e divide contextos grandes em duas ou seis mensagens. A última parte inicia a tarefa sem pedido adicional. Triplica os limites de contexto e compactação; reinicie o Codex após alterar. Pedidos extras podem aumentar bloqueios temporários. Desativado por padrão.",
  skillAttachments: "Skills como arquivos (experimental)",
  skillAttachmentsBody: "Envia skills selecionadas do Codex como arquivos de texto nomeados em vez de instruções embutidas. Outras skills continuam carregadas por ferramentas. Desativado por padrão; usa o mesmo limite dos anexos de imagem.",
  manualSkillAttachmentsUnavailable: "O envio de skills exige interação automática com o navegador.",
  savedChats: "Salvar conversas no ChatGPT",
  savedChatsBody: "Mantém as conversas das tarefas no histórico do ChatGPT. Memória e instruções personalizadas podem ser aplicadas. Desativado por padrão.",
  freshConversation: "Nova conversa do navegador a cada turno",
  freshConversationBody: "Reconstrói o contexto da mesma tarefa do Codex em uma nova conversa a cada turno. Pode ajudar quando o ChatGPT perde acesso às ferramentas, mas envia mais contexto e pode ser mais lento. Desativado por padrão.",
  manualFreshConversationUnavailable: "Disponível apenas com Automação. Sua preferência fica salva durante o modo Risco Zero.",
  biggerContextRecommendationTitle: "Use até 3× mais contexto",
  biggerContextRecommendationBody: "O Contexto maior envia tarefas grandes em várias mensagens para usar até três vezes mais contexto. Ainda é experimental e pode aumentar bloqueios temporários.",
  biggerContextRecommendationToggleBody: "Divide tarefas grandes em várias mensagens e aumenta os limites de contexto e compactação.",
  tagline: "ChatGPT Web dentro do ambiente nativo do Codex",
  chooseLanguage: "Escolha seu idioma",
  chooseLanguageHint: "Você pode alterar isto depois nas Configurações.",
  continue: "Continuar",
  supportTitle: "Antes de começar",
  supportBody: "Marque o repositório com uma estrela e abra meu perfil no X para ajudar mais desenvolvedores a encontrar o Codex Web GPT. Compartilho novidades e dicas úteis do Codex no X.",
  star: "Dar estrela no GitHub",
  starred: "GitHub aberto",
  follow: "Abrir meu X",
  followed: "X aberto",
  finishWelcome: "Abrir launcher",
  setup: "Configuração",
  activity: "Atividade",
  settings: "Configurações",
  updateAvailable: "Atualizar para",
  ...
  temporaryChat: "Conversa temporária",
  back: "Voltar",
  forward: "Avançar",
  reload: "Recarregar",
  ...
  hideTab: "Fechar aba",
  browserTabLimit: "Até cinco abas simultâneas do ChatGPT Web. O limite evita tráfego paralelo excessivo na sua conta.",
  browserAddress: "Navegador do ChatGPT",
  noActiveTask: "Nenhuma tarefa ativa",
  noActiveTaskBody: "O ChatGPT aparecerá aqui quando o Codex iniciar um turno com modelo Web.",
  activeTaskHidden: "Tarefa ativa em segundo plano",
  activeTaskHiddenBody: "O ChatGPT ainda está pensando e o Codex continua validando o turno ativo. Abra o ChatGPT para acompanhar o progresso.",
  browserReady: "Navegador pronto",
  showBrowser: "Mostrar ChatGPT",
  hideBrowser: "Ocultar ChatGPT",
  setupTitle: "Configurar o Codex Web GPT",
  setupSubtitle: "Três verificações disponibilizam o ChatGPT Web no seletor nativo de modelos do Codex.",
  coreSetup: "Configuração principal",
  interactionMode: "Interação com o ChatGPT",
  interactionModeOnboardingBody: "Escolha como o launcher deve trabalhar com o ChatGPT. Automação vem selecionada por padrão e pode ser alterada depois.",
  automaticInteraction: "Com Automação",
  automaticInteractionBody: "Envia prompts e lê o estado da página automaticamente. Tentativas controladas evitam envios repetidos, mas a automação pode conflitar com termos ou políticas da conta.",
  manualInteraction: "Risco Zero",
  manualInteractionBody: "Nunca lê nem altera o ChatGPT. O launcher prepara o prompt; você cola, escolhe conector, modelo e esforço e envia manualmente.",
  optional: "Opcional",
  required: "Obrigatório",
  stepAccount: "Entrar no ChatGPT",
  stepAccountBody: "Entre diretamente pelo navegador integrado. A sessão fica no perfil privado deste launcher.",
  signIn: "Abrir login",
  passkeySignIn: "Usar chave de acesso",
  passkeyContinue: "Continuar",
  passkeyImporting: "Importando…",
  passkeyContinueBody: "Conclua o login com chave de acesso na janela dedicada do Chrome, volte aqui e escolha Continuar.",
  checkingSignIn: "Verificando sessão salva",
  verifySignIn: "Verificar login",
  signedIn: "Conectado",
  stepSmoke: "Executar teste do navegador",
  stepSmokeBody: "Seleciona o esforço, envia uma pequena mensagem temporária e valida uma resposta completa por streaming.",
  runSmoke: "Executar teste",
  smokePassed: "Teste concluído",
  stepInstall: "Instalar no Codex",
  stepInstallBody: "Adiciona os modelos ChatGPT Web sem substituir o catálogo nativo. A rota personalizada atual é salva e restaurada quando a ponte é desativada.",
  bundledSkillsTitle: "Skills incluídas no aplicativo",
  bundledSkillsBody: "Escolha quais skills da base serão mantidas no Codex. Skills gerenciadas desmarcadas serão removidas; skills pessoais nunca serão apagadas.",
  keepAllSkills: "Manter todas",
  removeAllSkills: "Remover todas",
  zeroRiskModelSettings: "Perfis de modelo do Risco Zero",
  zeroRiskModelSettingsBody: "Escolha quais modelos serão instalados no Codex.",
  zeroRiskDefaultProfile: "Padrão",
  zeroRiskDefaultProfileBody: "Instala apenas ChatGPT Web — Risco Zero.",
  zeroRiskProProfile: "Pro",
  zeroRiskProProfileBody: "Também instala ChatGPT Web — Risco Zero Pro.",
  zeroRiskProProfileInfo: "Oferece cerca de 250.000 tokens úteis antes da compactação. Selecione ChatGPT Pro manualmente em cada turno. É necessária uma conta ChatGPT Pro; sem ela o turno pode falhar. O Risco Zero não consegue verificar sua assinatura ou seleção.",
  install: "Instalar modelos",
  reinstall: "Reinstalar",
  awaitingCodex: "Reinicie o Codex",
  restartCodex: "Feche completamente o Codex, incluindo o processo em segundo plano, e abra novamente para atualizar o seletor de modelos. Apenas fechar a janela não reinicia. Mantenha este launcher aberto.",
  mcpTitle: "Ferramentas nativas do Codex via MCP",
  mcpSubtitle: "Conecte o ChatGPT ao ambiente ativo do Codex por um túnel OpenAI.",
  mcpBody: "Permite que todos os esforços do ChatGPT Web, incluindo Pro, usem o ambiente ativo do Codex.",
  configureMcp: "Configurar MCP",
  mcpReady: "MCP configurado",
  close: "Fechar",
  previous: "Voltar",
  next: "Avançar",
  done: "Concluir",
  guideVideo: "Vídeo de ajuda",
  expandGuideVideo: "Ampliar vídeo",
  playGuideVideo: "Reproduzir vídeo",
  pauseGuideVideo: "Pausar vídeo",
  closeGuideVideo: "Fechar vídeo ampliado",
  mcpStepOne: "Criar túnel e chave de API",
  mcpStepOneBody: "Crie um túnel OpenAI, copie o ID e crie uma chave comum com Tunnels Read + Use. A chave serve apenas para executar o túnel. Não esqueça de criar um workspace do ChatGPT.",
  openTunnels: "Abrir Túneis",
  openKeys: "Criar chave de API",
  mcpStepTwo: "Conectar o ambiente local",
  mcpStepTwoBody: "Cole o ID do túnel e a chave. O túnel deve pertencer à mesma conta OpenAI usada pelo plugin. A chave fica armazenada localmente e não aparece nos logs.",
  mcpStepTwoHint: "O conector MCP só pode ser adicionado depois que esta etapa concluir e o túnel estiver ativo.",
  mcpCatalogRequired: "Conectar ambiente fica indisponível até os modelos do Codex serem instalados e verificados. Volte à Configuração, instale os modelos, reinicie o Codex e aguarde a verificação do catálogo.",
  tunnelId: "ID do túnel",
  runtimeKey: "Chave de API (não use chave Admin)",
  connect: "Conectar ambiente",
  reconnect: "Reconectar ambiente",
  credentialsConfigured: "Credenciais do túnel salvas",
  credentialsConfiguredBody: "O launcher reutilizará o ID e a chave armazenados com segurança neste dispositivo.",
  replaceCredentials: "Substituir credenciais",
  keepCredentials: "Manter credenciais salvas",
  mcpStepThree: "Anexar o conector do ChatGPT",
  mcpStepThreeBody: "Ative o Modo de desenvolvedor nas configurações do ChatGPT. Em Plugins, crie um conector do tipo Tunnel, selecione o túnel, use autenticação None e informe exatamente o nome abaixo. Em Permissões, escolha permitir todas as ações. Depois verifique o runtime.",
  manualMcpStepThreeBody: "Crie o conector separado abaixo com o nome exato Codex Zero Risk e selecione-o manualmente em cada turno. Ele exige túnel e credenciais próprios.",
  connectorMigrationNotice: "Ao atualizar do Codex Native, mantenha o conector antigo e crie Codex Native2 como um novo conector. Não renomeie o antigo.",
  manualConnectorNotice: "Codex Zero Risk é um conector separado. Selecione-o antes de cada prompt; o launcher não inspeciona a página nesse modo.",
  openConnectors: "Abrir Plugins do ChatGPT",
  connectorName: "Nome do conector",
  verifyRuntime: "Verificar runtime",
  checkingChatGptConnector: "Verificando conector do ChatGPT",
  doctorProxyHealthy: "Proxy Responses saudável em {endpoint}",
  doctorTunnelBinaryInstalled: "Binário fixado openai/tunnel-client instalado",
  doctorTunnelKeyStored: "Chave do runtime do túnel armazenada com segurança",
  doctorTunnelRuntimeOwned: "O launcher controla o runtime do túnel",
  doctorTunnelRuntimeReady: "Runtime do túnel saudável e pronto",
  doctorConnectorAvailable: "Conector do ChatGPT \"{name}\" disponível",
  activityTitle: "Atividade do runtime",
  activitySubtitle: "Diagnóstico local. Exporte uma cópia segura antes de compartilhar; os logs brutos ficam neste dispositivo.",
  recentActivity: "Eventos recentes",
  noLogs: "Nenhum evento do runtime ainda.",
  exportSafeLog: "Exportar log seguro",
  settingsTitle: "Configurações do launcher",
  general: "Geral",
  launchAtLogin: "Iniciar com o sistema",
  launchAtLoginBody: "Mantém a rota Responses local disponível antes do Codex abrir.",
  keepRunningOnClose: "Continuar executando ao fechar a janela",
  keepRunningOnCloseBody: "Oculta o launcher na bandeja para manter os modelos disponíveis.",
  showDuringTurns: "Mostrar navegador durante os turnos",
  showDuringTurnsBody: "Exibe o ChatGPT integrado sempre que um turno do navegador estiver ativo.",
  manualBiggerContextUnavailable: "O Risco Zero já usa intervalo fixo de compactação 3×. Seus prompts permanecem manuais e em uma única parte.",
  manualPromptTitle: "Envie este turno no ChatGPT",
  manualPromptInstruction: "O prompt já está na área de transferência. Cole na aba aberta, escolha modelo, esforço e conector Codex Zero Risk, envie e confirme abaixo.",
  manualPromptCopy: "Copiar prompt",
  manualPromptCancel: "Cancelar turno",
  manualPromptSent: "Enviado",
  manualPromptWaiting: "Aguardando conexão do Codex Zero Risk",
  manualPromptRunning: "O ChatGPT está trabalhando pelo ambiente do Codex",
  manualPromptSeconds: "segundos restantes",
  language: "Idioma",
  diagnostics: "Diagnóstico",
  runDoctor: "Executar diagnóstico",
  cancelTurns: "Cancelar turno ativo do Codex",
  cancelTurnsBody: "Interrompe o stream HTTP ativo e o turno retido do ChatGPT.",
  turnsCancelled: "Turno ativo do Codex cancelado",
  uninstallIntegration: "Reverter para o Codex nativo",
  uninstallIntegrationBody: "Faz backup e restaura a rota nativa anterior, remove somente os dados gerenciados pelo Web GPT e depois pede um único reinício do Codex.",
  integrationRemoved: "Codex nativo restaurado; reinicie o Codex",
  running: "Executando",
  complete: "Concluído",
  failed: "Falhou",
  healthy: "Saudável",
  ...
  dismiss: "Fechar",
  sessionReminderTitle: "Atualize sua sessão do ChatGPT",
  sessionReminderBody: "Recomendamos entrar novamente a cada dois dias. Uma sessão expirada pode interromper modelos Web e ferramentas MCP.",
  logOut: "Sair",
  checkingLocalRuntime: "Verificando runtime local",
  doctorConfigValid: "Configuração válida ({path})",
  doctorBrowserReady: "Navegador integrado autenticado e acessível (pid {pid})",
  doctorManualBrowserReady: "Navegador integrado acessível para Risco Zero (pid {pid})",
  doctorCodexInstalled: "Rota de modelos nativos do Codex instalada",
  doctorRuntimeOwned: "O launcher controla o runtime em segundo plano",
  doctorChromeFound: "Executável do Chrome encontrado: {path}",
  doctorLoginVerified: "Login do ChatGPT confirmado por evidência do navegador",
  doctorMacServiceLoaded: "Serviço em segundo plano do macOS carregado",

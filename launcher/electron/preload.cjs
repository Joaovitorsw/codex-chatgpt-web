...
contextBridge.exposeInMainWorld("codexWebLauncher", {
  ...
  setContextAttachments: (enabled) => ipcRenderer.invoke("launcher:context-attachments", enabled),
  setFreshConversationPerTurn: (enabled) => ipcRenderer.invoke("launcher:fresh-conversation-per-turn", enabled),
  cancelPendingFreshConversationPerTurn: () => ipcRenderer.invoke("launcher:fresh-conversation-per-turn-cancel"),
